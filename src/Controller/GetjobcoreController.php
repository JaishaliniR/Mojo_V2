    ...
    function xml2array ( $xmlObject, $out = array () )
{
 ...
 function ajaxcheckreworkincomplete(){
       ...
       $reworkCount =  $connection->execute("Select count(Id) as cnt from MV_QC_Comments where ProjectId = '" . $_POST['ProjectId'] . "' and RegionId='" . $_POST['RegionId'] . "' and InputEntityId='" . $_POST['InputEntityId'] . "' and RecordStatus=1 and StatusId=1")->fetchAll('assoc');
