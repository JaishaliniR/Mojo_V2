                ...
                <div class="panel-heading" role="tab" id="headingTwo">
                    <h3 class="panel-title">
                        ...
                        <span class="buttongrp">    
                            ...
                            <button type="submit" id="SubmitForm" style="" name='Submit' value="Submit" class="btn btn-primary btn-xs pull-right" >Save</button> 
                        </span>
                    </h3>
                </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group"style="margin: 0px;" >
                                ...
                                <div class="col-sm-8" style="padding-top: 3px;padding-left: 15px;">
                                        <a href="#">
                                            <span class="badge" id='countdowns'>00:04:33</span>
                                        </a> 
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="right-pane">
                        <div id="example111" style="padding: 10px">
                            ...
                            <table>
                                <tr>
                                    <td>Page 1</td>
                                    <td>&nbsp;&nbsp;<img src="../webroot/img/add.png"></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td><input placeholder="Level"></td>
                                    <td><input placeholder="Title"></td>
                                    <td>&nbsp;&nbsp;<img src="../webroot/img/delete.png">&nbsp;&nbsp;<img src="../webroot/img/search.png"></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td><input placeholder="Level"></td>
